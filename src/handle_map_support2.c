...
/*   Updated: 2026/01/06 17:25:20 by nneves-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	north_save_parameter(t_game *game, char *line, char *tmp)
{
	...
	if (tmp[i])
	{
		game->textures.north_texture = ft_strdup(tmp + i);
...
void	south_save_parameter(t_game *game, char *line, char *tmp)
{
	...
	if (tmp[i])
	{
		game->textures.south_texture = ft_strdup(tmp + i);
...
void	west_save_parameter(t_game *game, char *line, char *tmp)
{
	...
	if (tmp[i])
	{
		game->textures.west_texture = ft_strdup(tmp + i);
...
void	east_save_parameter(t_game *game, char *line, char *tmp)
{
	...
	if (tmp[i])
	{
		game->textures.east_texture = ft_strdup(tmp + i);
